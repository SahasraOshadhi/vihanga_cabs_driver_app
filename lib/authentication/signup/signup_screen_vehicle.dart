...
class _SignupVehicleState extends State<SignupVehicle> {
  ...
  TextEditingController vehicleInsidePicFrontController = TextEditingController();
  TextEditingController vehicleOutsidePicFrontController = TextEditingController();
  ...
  bool checkFormValidation(BuildContext context){
    ...
    if (vehicleModelTextEditingController.text.isEmpty ||
        vehicleInsidePicFrontController.text.isEmpty ||
        vehicleOutsidePicFrontController.text.isEmpty ||
                ...
                child: Column(
                  children: [
                    ...
                    ImagePickerTextField(
                      controller: vehicleOutsidePicFrontController,
                    ...
                    ImagePickerTextField(
                      controller: vehicleInsidePicFrontController,
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            if (isConnected && formIsValid) {
                              Navigator.push(context, MaterialPageRoute(builder: (c) => SignupFinal()));
                            }
                          },
